...
<body>
   ...
   <form name="IDCheck" method="post" action="userIDCheck.jsp">
      ...
      <input type="button" class="duplicate" onclick="popupIdCheck()"/>
   </form>
   ...
   %>
      ...
      <br> 
      <input type="button" class="regist" onclick="setId('<%=userID%>')" /> 
      <input type="button" class="cancel" onclick="selfClose()" />
   ...
   %>
      ...
      <br> <input type="button" class="cancel" onclick="selfClose()" />
