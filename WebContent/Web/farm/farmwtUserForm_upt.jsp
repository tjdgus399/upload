<%-- 
	■ SYSTEM                : SAF 양식장
	■ SOURCE FILE NAME      : farmwtUserForm_upt.jsp
	■ DESCRIPTION           : 담당자 검색 화면(farmwtUpdateForm.jsp에서 넘어옴)
...
<body>
   ...
   <%
	   ...
	   String tankID2 = request.getParameter("tankID2");            // 검색 수조 조건 값
	...
	%>
      ...
      <form name = "farmUser">
      <!-- farmwtUserPrc_upt.jsp에 넘겨줄 FarmID -->
      <center>
      ...
      <p>
         ...
         <!-- 담당자 검색시 farmwtUserPrc_upt.jsp로 넘어감 -->  
         <input type="image" src="../common/images/btn_a_inquiry.gif" onclick="searchuserCheck_upt(); return false;"/>
      ...
      <table class="tablefarmuser_upt">
         ...
         <tr>
            ...
            <input type="hidden" name="tankID2" value="<%=tankID2%>"/>
            
            <td>
            	<input type="image" src="../common/images/btn_a_select.gif" onclick="check_upt('<%=userid%>', '<%=FarmID%>','<%=tankID2%>')"/>
            </td>
         </tr>
